...
export const metadata = {
  title: "Valadares Fueta Advogados",
  ...
  return (
    <html lang="pt-BR">
      <head>
        <Script
          async
          src="https://www.googletagmanager.com/gtag/js?id=G-FZZYVKNC6D"
        ...
        <Script id="google-analytics" strategy="afterInteractive">
          {`
            ...
            gtag('js', new Date());
            gtag('config', 'G-FZZYVKNC6D');
          `}
        </Script>
      </head>
      <body className={inter.className}>
        <header>
          <img src="/fundo_branco3.svg" alt="" className="header__img" />
        ...
        <footer>
          <div className="footer__container">
            <div className="footer__container__esquerdo">
              <div className="footer__container__esquerdo__acima">
                ...
                <div className="footer__container__esquerdo__acima__termos">
                  <Link style={{ textDecoration: "none", color: "inherit" }} href="/termodeprivacidade">
                    <p>Termo de Privacidade</p>
                  </Link>
                  <Link style={{ textDecoration: "none", color: "inherit" }} href="/termodeuso">
                    <p>Termos de Uso</p>
                  </Link>
                  <Link style={{ textDecoration: "none", color: "inherit" }} href="/politicadecookies">
            ...
            <div className="footer__container__direito">
